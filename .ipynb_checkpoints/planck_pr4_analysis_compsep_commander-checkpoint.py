...
if os.path.exists('outputs_planck/planck_sepC_batch%d_%s.npy'%(batch_no,analysis_type)):
...
np.save('outputs_planck/planck_sepC_batch%d_%s.npy'%(batch_no,analysis_type),catalogue)