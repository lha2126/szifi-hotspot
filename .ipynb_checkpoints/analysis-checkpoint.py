...
sim_no = 0
test = is_interactive()
analysis_type = 'arnaud' # arnaud/point/soubhik
...
if os.path.exists('outputs_v2/ffp10_%d_batch%d_%s.npy'%(sim_no,batch_no,analysis_type)):
...
if analysis_type=='point':
    ...
    np.save('outputs_v2/ffp10_%d_batch%d_%s.npy'%(sim_no,batch_no,analysis_type),point_catalogues)
    ...
    np.save('outputs_v2/ffp10_%d_batch%d_%s.npy'%(sim_no,batch_no,analysis_type),catalogue)