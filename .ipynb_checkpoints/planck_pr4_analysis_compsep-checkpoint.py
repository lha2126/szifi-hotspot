...
if os.path.exists('outputs_planck/planck_sep_batch%d_%s.npy'%(batch_no,analysis_type)):
...
cutout_dir = '/insomnia001/home/lha2126/ceph/szifi_cutouts/planck_sep/'
...
np.save('outputs_planck/planck_sep_batch%d_%s.npy'%(batch_no,analysis_type),catalogue)