...
class input_data:
    ...
    def __init__(self,params_szifi=params.params_szifi_default,params_data=params.params_data_default):
        ...
        if (params_data["data_set"] == "Planck_real") or (params_data["data_set"] == "Planck_pr4"):
        ...
        if (params_data["data_set"] == "Planck_pr4_compsep") or (params_data["data_set"] == "Planck_pr4_compsep_E_data")  or (params_data["data_set"] == "cv_compsep"):
            ...
            if params_data["data_set"] == "Planck_pr4_compsep":
                exp_str = 'planck'
            ...
            for field_id in field_ids:
                ...
                [tmap] = np.load(path + "%s_field_"%exp_str + str(field_id) + "_tmap.npy")
                tmap = tmap*1e6
                ...
                [mask_galaxy,mask_point,mask_tile] = np.load(path + "%s_field_"%exp_str + str(field_id) + "_mask.npy")
                ...
                apotype="Smooth",aposcale=0.2)):
                     ...
                     cm_name = path + "../apod_comp_smooth_1024.fits"

                else:

                    cm_name = path + "../apod_comp_smooth_" + str(field_id) + ".fits"
