...
## Input options
assert len(sys.argv) == 3, "Must supply g and tile number"
...
cutout_dir = '/mnt/home/ophilcox/ceph/szifi_cutouts_new/ffp10_sep_%d/'%sim_no # all cutouts (will be large)
...
if all_exist:
    ...
    injection_map = [hp.read_map('/mnt/home/ophilcox/ceph/szifi_cutouts_new/cutout300_v3_sim%d_sep.fits'%sim_no)]
